...
const ProgramsData = () => {
    ...
    const programData = [
        {
            image: "mshiko2.jpg", title: "Mshiko Clubs", subTitle: "Mshiko Clubs", buttonText: '', description: "A project that aims at keeping girls in school by using a hybrid model of economic...",
        ...
        {
            image: "pandaDigital2.jpg", title: "Panda Digital", description: "Panda Digital is the first Swahili hybrid e-learning platform that uses a website and...",
...
` },
        ...
        {
            image: "pandaOnGround.jpg", title: "Panda on the Ground", subTitle: "Panda Digital", buttonText: '', description: "Panda on the Ground is a project that aims at planting a seed of financial freedom...",
             ...
             mentorship, and financial linkages, impacting over 210 women to launch businesses, and fostering financial
              independence and job creation. Over the next five years, the program aims to support 500 women in starting
               ...
               s rate in sustaining businesses. This initiative is expected to generate around 1,500 new jobs, significantly
                ...
                {
                    image: "digimali.jpg", title: "Digimali", description: "Digimali is a project is a project that focuses on enhancing the adaptation of digital business...",
        ...
        {
            image: "yeb.jpg", title: "Youth Employability Boot Camp", description: `This program focuses on honing the skills of young graduates, bridging the gap between...`,
        ...
        {
            image: "fika.jpg", title: "Fikia +", description: "FIKIA+ is a program that aims at supporting comprehensive implementation of HIV...",
        ...
        {
            image: "stawi2.jpg", title: "Stawi LAB", description: "The 'Stawi Lab' (Flourish Lab in English) project is at the forefront of an ambitious ecosystem...",
        ...
        {
            image: "pandaMovement.jpg", title: "PANDA DIGITAL MOVEMENT", description: "The Panda Digital Movement is dedicated to dismantling the structural...",
